...
class Ui_MainWindow(object):
    ...
    def classifyFunction(self):
        ...
        label = ["sunna", "ek", "das", "be", "tran", "char", "panc", "cha", "sat", "at", "nav", "ALA", "ANA", "B",
                 "BHA", "CH", "CHH", "D", "DA", "DH", "DHA", "F", "G", "GH", "GNA", "H", "J", "JH", "K", "KH", "KSH",
                 "L", "M", "N", "P", "R", "S", "SH", "SHH", "T", "TA", "TH", "THA", "V", "Y"]
    ...
    def trainingFunction(self):
        ...
        training_set = train_datagen.flow_from_directory(
            'D:/Pantech Internship Good quality videos/Day15/Code-15/Code-15/Dataset',
            target_size=(128, 128),
            batch_size=8,
